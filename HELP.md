...
- S&D is a tool.  As such, it can be used competently, or incompetently.  It is to your advantage to do your own mapping—by doing so, you have first-hand experience learning the area layouts and tricks.  Also, only you can know your individual needs; a DB supplied by someone else will almost certainly need a great deal of effort put into it to make it work correctly for you, often to the point that the effort needed will be comparable to that involved in simply mapping for yourself.  Don't do yourself a disservice by cutting corners—I encourage you to do your own mapping as that is the best way to learn.
